...
public class List<ContentType> {
  ...
  /* --------- Anfang der protectedn inneren Klasse -------------- */
  ...
  public class ListNode {
     ...
     */
    public ListNode(ContentType pContent, ListNode prev) {
  ...
  /* ----------- Ende der protectedn inneren Klasse -------------- */
  ...
  public void insert(ContentType pContent) {
    if (pContent != null) { // Nichts tun, wenn es keinen Inhalt gibt.
      if (this.hasAccess()) { // Fall: Es gibt ein aktuelles Element.
        ...
        ListNode newNode = new ListNode(pContent, current.getPreviousNode()); 
        ...
        if (this.isEmpty()) { // Fall: In leere Liste einfuegen.
          ...
          // Neuen Knoten erstellen.
          ListNode newNode = new ListNode(pContent, null); 
  ...
  public void append(ContentType pContent) {
    if (pContent != null) { // Nichts tun, wenn es keine Inhalt gibt.
      ...
      if (this.isEmpty()) { // Fall: An leere Liste anfuegen.
        ...
        // Neuen Knoten erstellen.
        ListNode newNode = new ListNode(pContent,last); 
